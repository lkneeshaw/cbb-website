        ...
        <div class="ui container">
            <div class="ui one column grid">
                <div class="center aligned column">
                    <h1>The Cherry Bomb Brawlers</h1>
                    <h2>Co-Ed Junior Roller Derby</h2>
                    <p>Flat Track | Full Contact | WFTDA Rules</p>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="ui container">
            <div class="ui two column grid">
                <div class="column">
                    ...
                    <button class="ui button">Join Us</button>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="ui container">
            <div class="ui two column grid">
                <div class="right floated column">
                    ...
                    <button class="ui button">See Calendar</button>
                </div>
            </div>
        </div>
    </section>
